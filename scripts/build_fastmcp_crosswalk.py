...
def build_markdown(
    ...
    lines.append("- [High-Level Totals](#high-level-totals)")
    lines.append("- [Docs Root Folder File Counts](#docs-root-folder-file-counts)")
    lines.append("- [`python-sdk` Group Counts](#python-sdk-group-counts)")
    lines.append("- [Examples Folder Coverage](#examples-folder-coverage)")
    lines.append("- [Tests Folder Coverage](#tests-folder-coverage)")
    lines.append("- [Non-`python-sdk` Doc to Source-Docs Mapping](#non-python-sdk-doc-to-source-docs-mapping)")
    lines.append("- [`python-sdk` Doc to Source-Code Mapping](#python-sdk-doc-to-source-code-mapping)")
    lines.append("")
    lines.append("## Inputs")
    lines.append("")
